  ...
  return (
    <header className="sticky top-0 z-50 border-b bg-background/80 px-4 backdrop-blur">
      <nav className="mx-auto flex w-full max-w-5xl items-center justify-between py-3">
        <Link to="/" search={{ date: undefined }} className="font-semibold no-underline">
          ✍️ WriteSpark
        </Link>
        <div className="flex items-center gap-3">
          <Link to="/" search={{ date: undefined }} className="text-sm no-underline opacity-85 hover:opacity-100">
            Journal
          </Link>
          <ThemeToggle />
        </div>
